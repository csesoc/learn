...
date: 2022-06-27
desc: Introducing state in React. Introducing state in React. Introducing state in React. Introducing state in React. Introducing state in React. Introducing state in React. Introducing state in React. Introducing state in React. Introducing state in React.
author: Gordon Huang
---
...
```jsx:src/App.jsx {5-6, 8} showLineNumbers
