...
These changes won't work just yet because the state in <FileName>Card.jsx </FileName> is undefined. But instead of moving all state from <FileName>App.jsx </FileName> to <FileName>Card.jsx </FileName>, we're going to do something slightly differently. In <FileName>App.jsx </FileName> we'll replace all of our state variables with a single state called `place` which will store all the info for our restaurant in a single JavaScript *Object*. A JavaScript Object is a type of data structure which stores key-value pairs.
...
<Centerer>
<img src="https://imgur.com/fPGAyaP.png" width="80%" />
</Centerer>
