...
const OpenDevTwo: NextPage = () => {
  return (
    <ArticleLayout>
      ...
      <p style={{ fontSize: "0.8rem" }}>Last updated 2022/12/16 00:25</p>
      ...
      <Flex
        ...
        <Card
          ...
          <EnabledExternLink>
            <Text as="a" href="https://terrie.notion.site/Intro-to-React-Part-1-Exercises-f960c27b17b94115b87c50bdfc4bbb3b" target="_blank">
              Exercises &nbsp;
            </Text>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M104,32V93.8a8.4,8.4,0,0,1-1.1,4.1l-63.6,106A8,8,0,0,0,46.1,216H209.9a8,8,0,0,0,6.8-12.1l-63.6-106a8.4,8.4,0,0,1-1.1-4.1V32" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></path><line x1="88" y1="32" x2="168" y2="32" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></line><path d="M62.6,165c11.8-8.7,32.1-13.6,65.4,3,35.7,17.9,56.5,10.8,67.9,1.1" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></path></svg>
          </EnabledExternLink>
        ...
        <Card
          ...
          <EnabledExternLink>
            <Text as="a" href="https://youtu.be/BVBVBJs-IDc" target="_blank">
          ...
          <EnabledExternLink>
            <Text as="a" href="https://youtu.be/HHPiAGK-440" target="_blank">
        ...
        <Card
          ...
          <EnabledExternLink>
            <Text as="a" href="https://www.canva.com/design/DAFQGm7-JI8/iTpjUQ5gdn5Q49cTuzudNQ/view?utm_content=DAFQGm7-JI8&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink" target="_blank">
              Workshop Slides &nbsp;
            </Text>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <EnabledExternLink>
            <Text as="a" href="https://raspy-neon-a4e.notion.site/CSESoc-Open-Dev-MongoDB-ExpressJS-f115394e8ecb4f09a3b767bf52c3e6e8" target="_blank">
              Exercises &nbsp;
            </Text>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M104,32V93.8a8.4,8.4,0,0,1-1.1,4.1l-63.6,106A8,8,0,0,0,46.1,216H209.9a8,8,0,0,0,6.8-12.1l-63.6-106a8.4,8.4,0,0,1-1.1-4.1V32" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></path><line x1="88" y1="32" x2="168" y2="32" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></line><path d="M62.6,165c11.8-8.7,32.1-13.6,65.4,3,35.7,17.9,56.5,10.8,67.9,1.1" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></path></svg>
          </EnabledExternLink>
          <EnabledExternLink>
            <Text as="a" href="https://youtu.be/9qAC3NnJAhg" target="_blank">
              Recording &nbsp;
            </Text>
            <svg
              xmlns="http://www.w3.org/2000/svg"
